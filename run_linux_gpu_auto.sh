...
SEED="${SEED:-42}"
OCR_SAMPLES_PER_CHAR="${OCR_SAMPLES_PER_CHAR:-50}"

# Training parameters — optimized for 4090 (24GB VRAM)
EPOCHS_NESTING="${EPOCHS_NESTING:-30}"
EPOCHS_OCR="${EPOCHS_OCR:-20}"
EPOCHS_COMPOSITE="${EPOCHS_COMPOSITE:-15}"
